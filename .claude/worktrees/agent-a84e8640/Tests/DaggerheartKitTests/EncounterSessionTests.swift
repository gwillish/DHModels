...
@MainActor struct PlayerSlotSessionTests {
  ...
  @Test func reducePlayerStress() {
    ...
    session.reduceStress(2, to: slot)
  ...
  @Test func markArmorSlotClampsToZero() {
    ...
    session.markArmorSlot(slotID)
    session.markArmorSlot(slotID)  // already at 0
  ...
  private func makeCompendium() -> Compendium {
    ...
    comp.addAdversary(
      Adversary(
        ...
        tier: 1, type: .bruiser, flavorText: "A disciplined mercenary.",
